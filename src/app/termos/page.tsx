                    ...
                    <div className="space-y-16 text-gray-300 leading-relaxed text-base text-justify">
                        ...
                        <section className="pt-8 group">
                            ...
                            <div className="pl-4 md:pl-12 border-l border-white/5">
                                ...
                                <div className="p-6 bg-gradient-to-r from-red-900/20 to-transparent border-l-2 border-red-500 rounded-r-xl">
                        ...
                        <section className="pt-16 mt-16 border-t border-white/5 text-center">
